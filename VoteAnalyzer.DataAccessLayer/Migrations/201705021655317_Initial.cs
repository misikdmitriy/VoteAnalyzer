namespace VoteAnalyzer.DataAccessLayer.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                    ...
                    c => new
                    {
                        ...
                        KnownVoteId = c.Guid(nullable: false),
                ...
                .ForeignKey("dbo.KnownVotes", c => c.KnownVoteId)
                .Index(c => c.DeputyId)
                .Index(c => c.VottingSessionId)
                .Index(c => c.KnownVoteId);
        }
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Votes", "KnownVoteId", "dbo.KnownVotes");
